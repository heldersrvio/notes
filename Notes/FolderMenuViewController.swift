...
class FolderMenuViewController: UITableViewController, UINavigationBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        folderIcon.frame = CGRect(x: label.frame.origin.x - label.frame.size.height * imageAspect * 2, y: label.frame.origin.y - label.frame.size.height * 0.25, width: label.frame.size.height * 1.5 * imageAspect, height: label.frame.size.height * 1.5)
